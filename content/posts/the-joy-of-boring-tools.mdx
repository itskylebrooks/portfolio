...
<figure className="post-figure">
  <SmartImage
    src="/media/the-joy-of-boring-tools.jpg"
    alt="'Just Use Apple Notes' Meme"
    width={1200}
    height={963}
  />
  <figcaption className="figure-caption">Meme used for commentary; logos © their respective owners.</figcaption>
</figure>
