export const meta = {
  ...
  tech: ['Knowledge Base', 'Aikido', 'Search', 'Localization', 'Contributions'],
  accent: 'lilac',
  links: {
...
- Loading is a gentle breathing dot — not because animations are fancy, but because it feels alive for a moment and then quietly fades away before you even think about it.
