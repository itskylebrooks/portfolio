      ...
      <MotionDiv animateKey={lang}>
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-white/80 italic">{lang === 'de' ? '(zentral für Hauptseite & alle verlinkten Projekte)' : '(central for main website & all linked projects)'}</p>
          </div>
        ...
        {lang === 'de' ? (
          ...
          <>
            <section>
              <h3 className="text-white text-lg font-semibold">Controller (Art. 4 No. 7 GDPR)</h3>
              <p className="mt-2 text-white/80">Kirill Bobrov (also: “Kyle Brooks”)
                <br />Volksdorfer Grenzweg 139
                <br />22359 Hamburg, Germany
                <br />Email: <a href="mailto:itskylebrooks@icloud.com" className="underline hover:text-white">itskylebrooks@icloud.com</a>
              </p>
            </section>
            ...
            <section>
              <h3 className="text-white text-lg font-semibold">1) Scope</h3>
              <p className="mt-2 text-white/80">This privacy policy applies to my personal website as well as to all publicly accessible projects and demos linked from it (collectively referred to as “Services”), provided these projects reference this policy in their footer or description. If an individual project processes additional data (e.g. user accounts, analytics, payment systems), it will be specifically explained on that project’s page.</p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">2) Types of Data Processed / Sources</h3>
              <p className="mt-2 text-white/80">- <strong>Usage and technical data:</strong> IP address, timestamp, requested resource/URL, referrer, browser, operating system (server logs).<br />
            ...
            <section>
              <h3 className="text-white text-lg font-semibold">3) Purposes and Legal Bases (Art. 6(1) GDPR)</h3>
              <p className="mt-2 text-white/80">- <strong>Operation, security, and error analysis</strong> of the services (server logs, cron jobs): legitimate interest (Art. 6(1)(f)).<br />
            ...
            <section>
              <h3 className="text-white text-lg font-semibold">4) Hosting & Server Log Files (Vercel)</h3>
              <p className="mt-2 text-white/80">The services are hosted by <strong>Vercel Inc.</strong> When accessed, server log data is automatically processed (IP address, date/time, requested file/URL, referrer, browser/OS). Purpose: service delivery, stability, security, and prevention of misuse (Art. 6(1)(f) GDPR). Log data is generally stored only briefly and then deleted or anonymized. Vercel stores data in EU data centers and only transfers data to third countries when necessary.</p>
              <p className="mt-2 text-white/80">Privacy policy: <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noreferrer" className="underline hover:text-white">Vercel Privacy Policy</a></p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">5) Scheduled Tasks (Vercel Cron Jobs)</h3>
              <p className="mt-2 text-white/80">For maintenance and automation, Vercel Cron Jobs call server-side endpoints at defined intervals. Technical log data such as IP, timestamp, and user-agent may be recorded; personal content is not processed. Legal basis: legitimate interest (Art. 6(1)(f) GDPR).</p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">6) Contact by Email</h3>
              <p className="mt-2 text-white/80">When contacting me by email, the provided data (address, content, metadata) is processed to handle your inquiry (Art. 6(1)(b/f) GDPR). The data will be deleted after the communication is completed unless legal retention obligations require otherwise.</p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">7) Feedback Forms → GitHub Issues (project-dependent)</h3>
              <p className="mt-2 text-white/80">If a project provides a feedback form, the entered data is transmitted server-side to <strong>GitHub</strong> to create an issue in the respective repository.</p>
              <p className="mt-2 text-white/80">- <strong>Recipient / controller:</strong> GitHub, Inc. / GitHub B.V. (independent controller).<br />
              ...
              <p className="mt-2 text-white/80">Privacy policy: <a href="https://docs.github.com/en/site-policy/privacy-policies/github-privacy-statement" target="_blank" rel="noreferrer" className="underline hover:text-white">GitHub Privacy Statement</a></p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">8) Cookies, Local Storage & Analytics</h3>
              <p className="mt-2 text-white/80">By default, the services <strong>do not use tracking cookies</strong> or any third-party tracking; fonts and scripts are served locally. If individual projects later use cookies or similar technologies (e.g. analytics), I will inform users in advance and obtain consent where required.</p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">9) Embedded Content (e.g. YouTube) & External Links</h3>
              <p className="mt-2 text-white/80">Some pages may embed external content (e.g. videos). When loading such content, the provider receives usage data (e.g. IP, user agent). I strive to use privacy-friendly embedding methods (e.g. “Click to Load”). For external links, the respective site’s privacy policy applies; I have no influence over their content or data handling.</p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">10) Recipients / Categories of Recipients</h3>
              <p className="mt-2 text-white/80">- <strong>Hosting / operations:</strong> Vercel (servers, logs, cron).<br />
            ...
            <section>
              <h3 className="text-white text-lg font-semibold">11) Data Transfers to Third Countries</h3>
              <p className="mt-2 text-white/80">Vercel and GitHub are providers based in the USA. When data is processed or transferred to third countries, appropriate safeguards are used (e.g. EU–US Data Privacy Framework, Standard Contractual Clauses, or equivalent mechanisms). Details can be found in the providers’ privacy policies.</p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">12) Storage Duration</h3>
              <p className="mt-2 text-white/80">Data is stored only as long as necessary for the respective purposes or as required by law. Afterwards, data is deleted or anonymized. Examples:<br />
            ...
            <section>
              <h3 className="text-white text-lg font-semibold">13) Obligation to Provide Data / Automated Decisions</h3>
              <p className="mt-2 text-white/80">There is no legal obligation to provide personal data unless necessary in a specific case (e.g. to respond). No <strong>automated decision-making</strong> including profiling takes place (Art. 22 GDPR).</p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">14) Security</h3>
              <p className="mt-2 text-white/80">I implement technical and organizational measures (TOMs) to protect data from loss, misuse, and unauthorized access, including TLS encryption (HTTPS). However, absolute security cannot be guaranteed.</p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">15) Data Subject Rights (Art. 15–21 GDPR)</h3>
              <p className="mt-2 text-white/80">You have, in particular, the following rights:<br />
              - Access, rectification, erasure, restriction, data portability, and objection to processing based on Art. 6(1)(f).<br />
              To exercise these rights, simply send an informal email to: <a href="mailto:itskylebrooks@icloud.com" className="underline hover:text-white">itskylebrooks@icloud.com</a></p>
              <p className="mt-2 text-white/80"><strong>Right to lodge a complaint:</strong><br />You may contact a supervisory authority, for example, the <em>Hamburg Commissioner for Data Protection and Freedom of Information (HmbBfDI).</em></p>
            </section>

            <hr className="my-6 border-white/10" />

            <section>
              <h3 className="text-white text-lg font-semibold">16) Changes to this Privacy Policy</h3>
              <p className="mt-2 text-white/80">I update this policy when services, legal requirements, or providers change. The current version is always available here; in case of significant changes, I will provide additional notice.</p>
            </section>
