    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-[color:var(--color-header-backdrop)] bg-[color:var(--color-header-bg)] border-b border-[color:var(--color-header-border)]">
      <div className="mx-auto max-w-[820px] px-4 py-3 flex items-center">
        <Link
          ...
          className="text-lg font-medium text-[color:var(--color-text-primary)] title-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-focus-ring)] ring-offset-2 ring-offset-[color:var(--color-ring-offset)]"
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <IconLink href="mailto:desk@itskylebrooks.tech" label="Email" Icon={Mail} />
        </div>
      </div>
    </header>
  )
